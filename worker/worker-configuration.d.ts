/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6977552057ab87f1f4f013b2009d6e1e)
// Runtime types generated with workerd@1.20260730.1 2026-03-10 
interface __BaseEnv_Env {
	CLIMATE_KV: KVNamespace;
	ANTHROPIC_API_KEY: string;
	APP_SECRET: string;
	SPIKE_COUNTER: DurableObjectNamespace<import("./src/index").SpikeCounter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SpikeCounter";
	}
